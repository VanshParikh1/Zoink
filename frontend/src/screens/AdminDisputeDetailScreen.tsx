...
const styles = StyleSheet.create({
  ...
  photoThumb: { width: 120, height: 120, borderRadius: 8, backgroundColor: theme.surfaceSubdued },
  ...
  chipSelected: { backgroundColor: theme.primarySurface, borderColor: theme.primary },

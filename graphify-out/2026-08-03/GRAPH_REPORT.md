...
## Corpus Check
- 173 files · ~226,462 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1262 nodes · 2493 edges · 101 communities (75 shown, 26 thin omitted)
...
Cohesion: 0.11
Nodes (18): react, SearchBar(), styles, Props, StateCard(), styles, Tone, ConversationThreadScreen() (+10 more)

### Community 6 - "listings.ts"
Cohesion: 0.11
Nodes (27): browseListings, createListing, deleteListing, deleteListingImage, getListing, getListingCategories, getMyListings, toggleAvailability (+19 more)

### Community 7 - "listingsApi.ts"
Cohesion: 0.11
Nodes (30): SearchScreen(), browseListings(), BrowseListingsParams, createListing(), CreateListingPayload, deleteListing(), deleteListingImage(), getListingCategories() (+22 more)

### Community 8 - "types/index.ts"
Cohesion: 0.12
Nodes (23): ACTIVE_STATUSES, AdminDisputeDetailScreen(), Nav, OUTCOME_LABELS, REASON_LABELS, RESOLUTION_OPTIONS, ScreenRoute, styles (+15 more)
...
Cohesion: 0.12
Nodes (21): activateBooking(), CreateBookingPayload, demoProfile, now, publicProfiles, toDemoUser(), bookings, conversations (+13 more)

### Community 11 - "PublicProfileScreen.tsx"
Cohesion: 0.33
Nodes (5): Nav, PublicProfileScreen(), ScreenRoute, styles, PublicProfile

### Community 12 - "AuthContext.tsx"
Cohesion: 0.08
Nodes (31): App(), plugins, isStripePublishableKeyConfigured(), STRIPE_PUBLISHABLE_KEY, AuthContext, AuthContextType, AuthProvider(), User (+23 more)

### Community 13 - "bookingsApi.ts"
Cohesion: 0.14
Nodes (21): Nav, ScreenRoute, styles, ZoinkItScreen(), completeBooking(), confirmHandoff(), createBooking(), getBooking() (+13 more)

### Community 14 - "backend/src/index.ts"
Cohesion: 0.11
Nodes (20): app, submitReview, requireAdmin(), requireAuth(), requireVerified(), router, router, router (+12 more)
...
Cohesion: 0.13
Nodes (20): Props, ScreenBackground(), styles, { width: W, height: H }, ZoinkFullLogo(), ZoinkFullLogoProps, useAuth(), Navigation() (+12 more)
...
Cohesion: 0.08
Nodes (21): AuthenticatedRequest, getDisputeDetail, listDisputes, resolveDispute, AuthenticatedRequest, createDispute, getDispute, getMyDisputes (+13 more)

### Community 21 - "errors.ts"
Cohesion: 0.28
...
Cohesion: 0.24
Nodes (9): BookingRequestsScreen(), Nav, styles, MyListingsScreen(), Nav, styles, getIncomingRequests(), BookingResponse (+1 more)
...
### Community 27 - "RootStackParamList"
Cohesion: 0.13
Nodes (16): RootStackParamList, DEFAULT_COORDS, HomeScreen(), Nav, styles, InboxScreen(), Nav, styles (+8 more)
...
Cohesion: 0.08
Nodes (34): average(), Badge, BadgeTone, buildBadges(), buildTier(), formatMemberSince(), ProfileCard(), ProfileCardProps (+26 more)
...
Cohesion: 0.22
Nodes (12): getConversationMessages(), getMyConversations(), markConversationRead(), openConversation(), sendMessage(), mockGetConversationMessages(), mockGetMyConversations(), mockMarkConversationRead() (+4 more)
...
### Community 40 - "authService.ts"
Cohesion: 0.15
Nodes (15): generateOTP(), isEmailDomainAllowed(), loginUser(), registerUser(), resendOTP(), sendVerificationEmail(), sesClient, signJWT() (+7 more)

### Community 41 - "reviewService.ts"
Cohesion: 0.27
Nodes (9): assertScore(), average(), getPendingReviews(), recomputeUserReputation(), scoreLabelsForRole(), submitReview(), SubmitReviewInput, toDecimal() (+1 more)
...
### Community 43 - "dto.ts"
Cohesion: 0.14
Nodes (14): mockGetPendingReviews(), mockSubmitReview(), submitReview(), SubmitReviewPayload, BookingListingSnapshot, BrowseListingsResult, ConversationListingSnapshot, ConversationMessagePreview (+6 more)
...
Cohesion: 0.36
Nodes (7): ActiveRentalScreen(), daysLeft(), fullName(), Nav, ScreenRoute, shortDate(), styles

### Community 49 - "disputesApi.ts"
Cohesion: 0.21
Nodes (11): DEMO_MODE, DEMO_TOKEN, DEMO_USER, createDispute(), CreateDisputePayload, getDispute(), getMyDisputes(), mockCreateDispute() (+3 more)

### Community 50 - "BookingHistoryScreen.tsx"
Cohesion: 0.43
Nodes (6): BookingHistoryScreen(), formatDateRange(), isActiveRental(), Nav, statusTone(), styles

### Community 51 - "index.tsx"
Cohesion: 0.15
Nodes (12): Stack, VerifiedAppStack(), FileDisputeScreen(), Nav, REASON_OPTIONS, ScreenRoute, styles, Nav (+4 more)
...
- **Why does `expo-secure-store` connect `AuthContext.tsx` to `useAuth`, `MyProfileScreen.tsx`?**
